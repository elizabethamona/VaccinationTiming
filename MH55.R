SEIRD8V <- function( S0, E0, I0, II0,
                     RE0, RI0, SI0, RR0, D0, V0, alpha1, beta1,  gamma1, gamma2,  eta1, 
  ...
  Out2a <- SEIRDV8cpp(S0, E0, I0, II0,
                      RE0, RI0, SI0, RR0, D0, V0, alpha11v, beta1, gamma1v, 
                      gamma2, eta1,
...
LikeSEIRD8V2 <- function( data3, S0, E0, I0, II0, 
  ...
  Out2 <- SEIRD8V(  S0, E0, I0, II0, 
                    RE0, RI0, SI0, RR0, D0, V0, alpha1, beta1,  gamma1, gamma2,
                    eta1, 
...
MCMCSEIRD8VPred <- function( data3, S0, E0, I0, II0,
  ...
  mchpt1 <- list( X1a = X1a, X1b = X1b, X1g = X1g, X1m = X1m, X1p1=X1p1)
  ...
  for( i in 1:nsamp1 ){
    for( j in 1:length( alpha1 ) ){
      ...
      if( alpha1t[j] > 0 ){
        Post2t <- PostSEIRD8V1( data3, S0, E0, I0, II0, 
                                RE0, RI0, SI0, RR0, D0, V0, alpha1t, beta1,  gamma1, 
    ...
    if( beta1t > 0 ){
      Post2t <- PostSEIRD8V1(  data3, S0, E0, I0, II0, 
                               RE0, RI0, SI0, RR0, D0, V0, alpha1, beta1t,  gamma1, 
                               gamma2, eta1, 
                               rho1,  phi1,  zeta1, zeta2, kappa1, n1, mchpt1,
                               prior1am=prior1am, prior1b=prior1b, prior1g=prior1g,
                               prior1g2=prior1g2, prior1e=prior1e, prior1m=prior1m,
    ...
    for( j in 1:length( gamma1 ) ){
      ...
      if( gamma1t[j] > 0) {
        Post2t <- PostSEIRD8V1(  data3, S0, E0, I0, II0, 
                                 RE0, RI0, SI0, RR0, D0, V0, alpha1, beta1,  gamma1t, 
                                 gamma2, eta1, 
                                 rho1,  phi1,  zeta1, zeta2, kappa1, n1, mchpt1,
                                 prior1am=prior1am, prior1b=prior1b, prior1g=prior1g,
                                 prior1g2=prior1g2, prior1e=prior1e, prior1m=prior1m,
    ...
    if( kappa1t > 0 ){
      Post2t <- PostSEIRD8V1(  data3, S0, E0, I0, II0, 
                               RE0, RI0, SI0, RR0, D0, V0, alpha1, beta1,  gamma1, 
                               gamma2, eta1, 
                               rho1,  phi1, zeta1, zeta2, kappa1t, n1, mchpt1,
                               prior1am=prior1am, prior1b=prior1b, prior1g=prior1g,
                               prior1g2=prior1g2, prior1e=prior1e, prior1m=prior1m,
                               prior1p1=prior1p1, prior1z1=prior1z1, 
                               prior1z2=prior1z2, prior1k=prior1k )
